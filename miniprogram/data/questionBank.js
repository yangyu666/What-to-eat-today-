...
exports.questionBank = exports.QUESTION_OPTION_IMAGES = exports.QUESTION_BANK_VERSION = void 0;
exports.findQuestionOption = findQuestionOption;
exports.QUESTION_BANK_VERSION = 'v2.2-breadth';
exports.QUESTION_OPTION_IMAGES = {
        ...
        options: [
            {
                ...
                visual: '避',
                icon: '避',
                imageUrl: exports.QUESTION_OPTION_IMAGES.avoidanceSpicy,
                effect: {
            ...
            },
            {
                ...
                visual: '清',
                icon: '清',
                imageUrl: exports.QUESTION_OPTION_IMAGES.avoidanceGreasy,
                effect: {
            ...
            },
            {
                ...
                visual: '开',
                icon: '开',
                imageUrl: exports.QUESTION_OPTION_IMAGES.avoidanceNone,
                effect: {}
            }
        ]
    },
        ...
        options: [
            {
                ...
                visual: '淡',
                icon: '淡',
                imageUrl: exports.QUESTION_OPTION_IMAGES.spiceNo,
                effect: {
            ...
            },
            {
                ...
                visual: '微',
                icon: '微',
                imageUrl: exports.QUESTION_OPTION_IMAGES.spiceMild,
                effect: {
            ...
            },
            {
                ...
                visual: '辣',
                icon: '辣',
                imageUrl: exports.QUESTION_OPTION_IMAGES.spiceYes,
                effect: {
        ...
        options: [
            {
                ...
                visual: '近',
                icon: '近',
                imageUrl: exports.QUESTION_OPTION_IMAGES.distanceNear,
                effect: {
            ...
            },
            {
                ...
                visual: '行',
                icon: '行',
                imageUrl: exports.QUESTION_OPTION_IMAGES.distanceWalk,
                effect: {
            ...
            },
            {
                ...
                visual: '远',
                icon: '远',
                imageUrl: exports.QUESTION_OPTION_IMAGES.distanceAny,
                effect: {
        ...
        options: [
            {
                ...
                visual: '¥',
                icon: '¥',
                imageUrl: exports.QUESTION_OPTION_IMAGES.budgetLow,
                effect: {
            ...
            },
            {
                ...
                visual: '¥',
                icon: '¥',
                imageUrl: exports.QUESTION_OPTION_IMAGES.budgetMid,
                effect: {
        ...
        options: [
            {
                ...
                visual: '清',
                icon: '清',
                imageUrl: exports.QUESTION_OPTION_IMAGES.flavorLight,
                effect: {
            ...
            },
            {
                ...
                visual: '辣',
                icon: '辣',
                imageUrl: exports.QUESTION_OPTION_IMAGES.flavorStrong,
                effect: {
        ...
        options: [
            {
                ...
                visual: '轻',
                icon: '轻',
                imageUrl: exports.QUESTION_OPTION_IMAGES.healthLight,
                effect: {
            ...
            },
            {
                ...
                visual: '放',
                icon: '放',
                imageUrl: exports.QUESTION_OPTION_IMAGES.healthFree,
                effect: {
        ...
        options: [
            {
                ...
                visual: '饱',
                icon: '饱',
                imageUrl: exports.QUESTION_OPTION_IMAGES.satietyFilling,
                effect: {
            ...
            },
            {
                ...
                visual: '垫',
                icon: '垫',
                imageUrl: exports.QUESTION_OPTION_IMAGES.satietyLight,
                effect: {
        ...
        options: [
            {
                ...
                visual: '饭',
                icon: '饭',
                imageUrl: exports.QUESTION_OPTION_IMAGES.mealMain,
                effect: {
                    positiveTags: ['staple', 'rice', 'noodle', 'meal', 'set_meal'],
                    softPreferences: { mealWeight: 'filling', amapKeywords: ['盖饭', '面', '套餐'] }
                }
            },
            {
                ...
                visual: '点',
                icon: '点',
                imageUrl: exports.QUESTION_OPTION_IMAGES.mealSnack,
                effect: {
        ...
        options: [
            {
                ...
                visual: '热',
                icon: '热',
                imageUrl: exports.QUESTION_OPTION_IMAGES.temperatureHot,
                effect: {
            ...
            },
            {
                ...
                visual: '凉',
                icon: '凉',
                imageUrl: exports.QUESTION_OPTION_IMAGES.temperatureCold,
                effect: {
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                visual: '慢',
                icon: '慢',
                imageUrl: exports.QUESTION_OPTION_IMAGES.speedSlow,
                effect: {
                    positiveTags: ['relaxed', 'slow'],
        ...
        options: [
            {
                ...
                visual: '暖',
                icon: '暖',
                imageUrl: exports.QUESTION_OPTION_IMAGES.moodComfort,
                effect: {
            ...
            },
            {
                ...
                visual: '新',
                icon: '新',
                imageUrl: exports.QUESTION_OPTION_IMAGES.moodFresh,
                effect: {
        ...
        options: [
            {
                ...
                visual: '一',
                icon: '一',
                imageUrl: exports.QUESTION_OPTION_IMAGES.sceneSolo,
                effect: {
            ...
            },
            {
                ...
                visual: '聚',
                icon: '聚',
                imageUrl: exports.QUESTION_OPTION_IMAGES.sceneGroup,
                effect: {
        ...
        options: [
            {
                ...
                visual: 'meal',
                icon: 'meal',
                imageUrl: exports.QUESTION_OPTION_IMAGES.intentMeal,
                effect: {
            ...
            },
            {
                ...
                visual: 'drink',
                icon: 'cup',
                imageUrl: exports.QUESTION_OPTION_IMAGES.intentDrink,
                effect: {
            ...
            },
            {
                ...
                visual: 'sweet',
                icon: 'cake',
                imageUrl: exports.QUESTION_OPTION_IMAGES.intentDessert,
                effect: {
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                visual: 'veg',
                icon: 'leaf',
                imageUrl: exports.QUESTION_OPTION_IMAGES.dietaryVegetarian,
                effect: {
            ...
            },
            {
                ...
                visual: 'halal',
                icon: 'halal',
                imageUrl: exports.QUESTION_OPTION_IMAGES.dietaryHalal,
                effect: {
            ...
            },
            {
                ...
                visual: 'safe',
                icon: 'safe',
                imageUrl: exports.QUESTION_OPTION_IMAGES.dietaryLowSugar,
                effect: {
        ...
        options: [
            {
                ...
                visual: 'am',
                icon: 'sun',
                imageUrl: exports.QUESTION_OPTION_IMAGES.timeBreakfast,
                effect: {
            ...
            },
            {
                ...
                visual: 'night',
                icon: 'moon',
                imageUrl: exports.QUESTION_OPTION_IMAGES.timeLateNight,
                effect: {
            ...
            },
            {
                ...
                visual: 'tea',
                icon: 'tea',
                imageUrl: exports.QUESTION_OPTION_IMAGES.timeAfternoonTea,
                effect: {
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                visual: 'protein',
                icon: 'protein',
                imageUrl: exports.QUESTION_OPTION_IMAGES.dietaryProtein,
                effect: {
    ...
    },
    {
        ...
        options: [
            ...
            },
            {
                ...
                visual: 'noDrink',
                icon: 'noCup',
                imageUrl: exports.QUESTION_OPTION_IMAGES.avoidDrinks,
                effect: {
            ...
            },
            {
                ...
                visual: 'lightOnly',
                icon: 'light',
                imageUrl: exports.QUESTION_OPTION_IMAGES.avoidMeal,
                effect: {
            ...
            },
            {
                ...
                visual: 'noPork',
                icon: 'noPork',
                imageUrl: exports.QUESTION_OPTION_IMAGES.preferHalal,
                effect: {
                    positiveTags: ['halal'],
                    negativeTags: ['pork', 'meat_heavy'],
        ...
        options: [
            {
                ...
                visual: 'milkTea',
                icon: 'cup',
                imageUrl: exports.QUESTION_OPTION_IMAGES.preferMilkTea,
                effect: {
            ...
            },
            {
                ...
                visual: 'coffee',
                icon: 'coffee',
                imageUrl: exports.QUESTION_OPTION_IMAGES.preferCoffee,
                effect: {
            ...
            },
            {
                ...
                visual: 'bakery',
                icon: 'cake',
                imageUrl: exports.QUESTION_OPTION_IMAGES.preferBakery,
                effect: {
        ...
        options: [
            {
                ...
                visual: '店',
                icon: '店',
                imageUrl: exports.QUESTION_OPTION_IMAGES.diningDineIn,
                effect: {
...
function findQuestionOption(questionId, optionIds = [], value) {
    const question = exports.questionBank.find((item) => item.id === questionId);
    if (!question) {
        return undefined;
    }
